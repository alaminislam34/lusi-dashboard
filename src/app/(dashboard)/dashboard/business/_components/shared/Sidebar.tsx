...
const menuItems = [
  { name: "Dashboard", icon: LayoutDashboard, href: "/business" },
  { name: "Leads", icon: User, href: "/business/leads" },
  {
    name: "Conversations",
    icon: MessageSquare,
    href: "/business/conversations",
  },
  { name: "App", icon: RiRobot3Fill, href: "/business/app" },
  { name: "Setting", icon: Settings, href: "/business/settings" },
];
